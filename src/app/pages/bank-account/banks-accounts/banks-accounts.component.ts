...
import { BankAccountService as ModelService } from '../_services/bank-account.service';
...
@Component({
    ...
    styleUrls: ['./banks-accounts.component.scss']
})
export class BanksAccountsComponent implements OnInit {
    ...
    public getModels() {
        ...
        this.modelsService.get(this.page, this.per_page, this.sort, this.query, this.filters).toPromise().then(
            response => {
                this.requesting = false;
                this.models = response.bank_accounts;

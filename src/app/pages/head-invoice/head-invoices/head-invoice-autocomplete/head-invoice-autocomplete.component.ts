...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => HeadInvoiceAutocompleteComponent),
    multi: true,
};

@Component({
    selector: 'app-head-invoice-autocomplete',
    templateUrl: './head-invoice-autocomplete.component.html',
    styleUrls: ['./head-invoice-autocomplete.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class HeadInvoiceAutocompleteComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;

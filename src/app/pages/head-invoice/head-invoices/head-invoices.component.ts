...
import { HeadInvoiceService as ModelService } from '../_services/head-invoice.service';
...
@Component({
    ...
    styleUrls: ['./head-invoices.component.scss']
})
export class HeadInvoicesComponent implements OnInit {

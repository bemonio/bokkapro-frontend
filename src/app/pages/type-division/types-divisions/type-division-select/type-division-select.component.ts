...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => TypeDivisionSelectComponent),
    multi: true,
};

@Component({
    selector: 'app-type-division-select',
    templateUrl: './type-division-select.component.html',
    styleUrls: ['./type-division-select.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class TypeDivisionSelectComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;

...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => TypeDivisionAutocompleteComponent),
    multi: true,
};

@Component({
    selector: 'app-type-division-autocomplete',
    templateUrl: './type-division-autocomplete.component.html',
    styleUrls: ['./type-division-autocomplete.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class TypeDivisionAutocompleteComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;
    ...
    getModels() {
        this.modelsService.get(this.page, this.per_page, this.sort, this.query, this.filters, this._with).toPromise().then(
            response => {
                this.models = response.type_divisions;

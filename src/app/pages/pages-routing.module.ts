...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'stocks',
        loadChildren: () =>
          import('../pages/stock/stock-routing.module').then(
      ...
      {
        path: 'stocktransactiondetails',
        loadChildren: () =>
          import('../pages/stock-transaction-detail/stock-transaction-detail-routing.module').then(
            (m) => m.StockTransactionDetailRoutingModule
          ),
      },
      {
        path: 'stockserials',
      ...
      },
      {
        path: 'typeschests',
        loadChildren: () =>
          import('../pages/type-chest/type-chest-routing.module').then(

...
export class StockSerialService {
    API_URL = `${environment.apiUrl}stockserials`;
    ...
    public get (page?: number, per_page?: number, sort?: string, query?: string, filters?: any[], _with?: any[]): Observable<any> {
        ...
        return this.http.get(`${this.API_URL}?${params}&include[]=product_and_service.*&include[]=stock_transaction.*&include[]=stock.*`);
    }
    ...
    public getById(id: number): Observable<any> {
        return this.http.get(`${this.API_URL}/${id}?include[]=product_and_service.*&include[]=stock_transaction.*&include[]=stock.*`);
    }
}

...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => OfficeMultiselectComponent),
    multi: true,
};

@Component({
    selector: 'app-office-multiselect',
    templateUrl: './office-multiselect.component.html',
    styleUrls: ['./office-multiselect.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class OfficeMultiselectComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;

...
import { ReportRequestService as ModelService } from '../_services/report-request.service';
import { ReportRequestModel as Model } from '../_models/report-request.model';
...
@Component({
    ...
    styleUrls: ['./report-requests.component.scss']
})
export class ReportRequestsComponent implements OnInit {
    ...
    public getModels() {
        ...
        this.modelsService.get(this.page, this.per_page, this.sort, this.query, this.filters, this._with).subscribe(
            response => {
                this.requesting = false;
                this.models = response.report_requests;

...
export class ReportRequestService {
    API_URL = `${environment.apiUrl}reportrequests`;
    ...
    public get (page?: number, per_page?: number, sort?: string, query?: string, filters?: any[], _with?: any[]): Observable<any> {
        ...
        return this.http.get(`${this.API_URL}?${params}&include[]=employee.*`);
    }
    ...
    public getById(id: number): Observable<any> {
        return this.http.get(`${this.API_URL}/${id}/?include[]=employee.*`);
    }
}

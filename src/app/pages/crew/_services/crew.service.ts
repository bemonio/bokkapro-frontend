...
export class CrewService {
    API_URL = `${environment.apiUrl}crews`;
    ...
    public get (page?: number, per_page?: number, sort?: string, query?: string, filters?: any[], _with?: any[]): Observable<any> {
        ...
        return this.http.get(`${this.API_URL}?${params}&include[]=division.*&include[]=driver.*&include[]=assistant.*&include[]=assistant2.*&include[]=vehicle.*&include[]=office.*`);
    }
    ...
    public getById(id: number): Observable<any> {
        return this.http.get(`${this.API_URL}/${id}/?include[]=division.*&include[]=driver.*&include[]=assistant.*&include[]=assistant2.*&include[]=vehicle.*&include[]=office.*`);
    }
}

...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => CrewAutocompleteComponent),
    multi: true,
};

@Component({
    selector: 'app-crew-autocomplete',
    templateUrl: './crew-autocomplete.component.html',
    styleUrls: ['./crew-autocomplete.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class CrewAutocompleteComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;

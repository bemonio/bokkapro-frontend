...
import { TypeContractService as ModelsService } from '../../_services/type-contract.service';
import { LazyLoadEvent } from 'primeng/api';
import { ToastService } from 'src/app/modules/toast/_services/toast.service';
import { AuthService } from 'src/app/modules/auth';
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => TypeContractSelectComponent),
    multi: true,
};

@Component({
    selector: 'app-type-contract-select',
    templateUrl: './type-contract-select.component.html',
    styleUrls: ['./type-contract-select.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class TypeContractSelectComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;

...
export class DivisionSelectComponent implements ControlValueAccessor, OnInit, OnChanges {
    @Input() model: any;
    @Input() valid: boolean;
    ...
    public change($event) {
        ...
        this.divisionValue.emit(this.value);
    }
    ...
    getModels() {
        this.modelsService.getAutocomplete(this.page, this.per_page, this.sort, this.query, this.filters, this._with).subscribe(
            response => {

...
import { PasswordSettingService as ModelService } from '../_services/password-setting.service';
...
@Component({
    selector: 'app-passwords-settings',
    templateUrl: './passwords-settings.component.html',
    styleUrls: ['./passwords-settings.component.scss']
})
export class PasswordsSettingsComponent implements OnInit {

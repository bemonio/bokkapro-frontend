...
import { QuoteTemplateService as ModelService } from '../_services/quote-template.service';
...
@Component({
    ...
    templateUrl: './quote-templates.component.html',
    styleUrls: ['./quote-templates.component.scss']
})

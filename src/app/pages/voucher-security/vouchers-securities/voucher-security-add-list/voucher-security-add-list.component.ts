...
import { VoucherSecurityListModel as Model } from '../../_models/voucher-security-list.model';
...
@Component({
  selector: 'app-voucher-security-add-list',
  templateUrl: './voucher-security-add-list.component.html',
  styleUrls: ['./voucher-security-add-list.component.scss']
})
export class VoucherSecurityAddListComponent implements OnInit, OnDestroy {

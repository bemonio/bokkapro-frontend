...
@Component({
  selector: 'app-voucher-security-edit',
  templateUrl: './voucher-security-edit.component.html',
  styleUrls: ['./voucher-security-edit.component.scss']
})
export class VoucherSecurityEditComponent implements OnInit, OnDestroy {

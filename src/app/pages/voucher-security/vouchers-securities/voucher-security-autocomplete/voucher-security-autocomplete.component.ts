...
import { VoucherSecurityService as ModelsService } from '../../_services/voucher-security.service';
import { LazyLoadEvent } from 'primeng/api';
import { ToastService } from 'src/app/modules/toast/_services/toast.service';
import { AuthService } from 'src/app/modules/auth';
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => VoucherSecurityAutocompleteComponent),
    multi: true,
};

@Component({
    selector: 'app-voucher-security-autocomplete',
    templateUrl: './voucher-security-autocomplete.component.html',
    styleUrls: ['./voucher-security-autocomplete.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class VoucherSecurityAutocompleteComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;

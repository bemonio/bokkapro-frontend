...
export class VoucherService {
    ...
    API_URL_DEVOLUTION = `${environment.apiUrl}devolutionvoucher`;
    ...
    public devolution(id: number, body: Object): Observable<any> {
        return this.http.post(`${this.API_URL_DEVOLUTION}`, JSON.stringify(body));
    }
}

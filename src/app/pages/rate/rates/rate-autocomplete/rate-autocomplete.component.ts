...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => RateAutocompleteComponent),
    multi: true,
};

@Component({
    selector: 'app-rate-autocomplete',
    templateUrl: './rate-autocomplete.component.html',
    styleUrls: ['./rate-autocomplete.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class RateAutocompleteComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;

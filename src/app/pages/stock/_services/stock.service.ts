...
export class StockService {
    API_URL = `${environment.apiUrl}stocks`;
    ...
    public get (page?: number, per_page?: number, sort?: string, query?: string, filters?: any[], _with?: any[]): Observable<any> {
        ...
        return this.http.get(`${this.API_URL}?${params}&include[]=office.*&include[]=product_and_service.*`);
    }
    ...
    public getById(id: number): Observable<any> {
        return this.http.get(`${this.API_URL}/${id}?include[]=office.*&include[]=product_and_service.*`);
    }
}

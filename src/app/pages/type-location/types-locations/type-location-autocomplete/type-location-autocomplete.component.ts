...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => TypeLocationAutocompleteComponent),
    multi: true,
};

@Component({
    selector: 'app-type-location-autocomplete',
    templateUrl: './type-location-autocomplete.component.html',
    styleUrls: ['./type-location-autocomplete.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class TypeLocationAutocompleteComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;
    ...
    getModels() {
        this.modelsService.get(this.page, this.per_page, this.sort, this.query, this.filters).toPromise().then(
            response => {
                this.models = response.type_locations;

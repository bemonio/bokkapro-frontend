...
import { TypeLocationService as ModelService } from '../_services/type-location.service';
...
@Component({
    selector: 'app-types-locations',
    templateUrl: './types-locations.component.html',
    styleUrls: ['./types-locations.component.scss']
})
export class TypesLocationsComponent implements OnInit {

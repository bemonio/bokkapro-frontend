...
import { SegmentCompanyService as ModelService } from '../_services/segment-company.service';
...
@Component({
    selector: 'app-segments-companies',
    templateUrl: './segments-companies.component.html',
    styleUrls: ['./segments-companies.component.scss']
})
export class SegmentsCompaniesComponent implements OnInit {

...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => SegmentCompanyAutocompleteComponent),
    multi: true,
};

@Component({
    selector: 'app-segment-company-autocomplete',
    templateUrl: './segment-company-autocomplete.component.html',
    styleUrls: ['./segment-company-autocomplete.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class SegmentCompanyAutocompleteComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;

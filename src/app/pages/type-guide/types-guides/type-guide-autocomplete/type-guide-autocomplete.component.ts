...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => TypeGuideAutocompleteComponent),
  multi: true,
};

@Component({
  selector: 'app-type-guide-autocomplete',
  templateUrl: './type-guide-autocomplete.component.html',
  styleUrls: ['./type-guide-autocomplete.component.scss'],
  providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class TypeGuideAutocompleteComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;
    ...
    getModels() {
        this.modelsService.get(this.page, this.per_page, this.sort, this.query, this.filters).toPromise().then(
            response => {
                this.models = response.type_guides;

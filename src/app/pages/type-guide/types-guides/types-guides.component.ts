...
import { TypeGuideService as ModelService } from '../_services/type-guide.service';
...
@Component({
  selector: 'app-types-guides',
  templateUrl: './types-guides.component.html',
  styleUrls: ['./types-guides.component.scss']
})
export class TypesGuidesComponent implements OnInit {

...
export class StockTransactionService {
    API_URL = `${environment.apiUrl}stocktransactions`;
    ...
    public get (page?: number, per_page?: number, sort?: string, query?: string, filters?: any[], _with?: any[]): Observable<any> {
        ...
        return this.http.get(`${this.API_URL}?${params}&include[]=office.*&include[]=service_order.*&include[]=employee.*&include[]=type_product_transaction.*`);
    }
    ...
    public getById(id: number): Observable<any> {
        return this.http.get(`${this.API_URL}/${id}?include[]=office.*&include[]=service_order.*&include[]=employee.*&include[]=type_product_transaction.*`);
    }
}

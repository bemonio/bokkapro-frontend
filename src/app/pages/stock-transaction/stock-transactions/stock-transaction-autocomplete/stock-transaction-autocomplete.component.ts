...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => StockTransactionAutocompleteComponent),
    multi: true,
};

@Component({
    selector: 'app-stock-transaction-autocomplete',
    templateUrl: './stock-transaction-autocomplete.component.html',
    styleUrls: ['./stock-transaction-autocomplete.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class StockTransactionAutocompleteComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;

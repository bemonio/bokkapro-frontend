...
export class ReportOperationService {
    API_URL = `${environment.apiUrl}reportoperations`;
    ...
    public get (page?: number, per_page?: number, sort?: string, query?: string, filters?: any[], _with?: any[]): Observable<any> {
        ...
        return this.http.get(`${this.API_URL}?${params}&include[]=employees_open.*&include[]=employees_close.*&include[]=office.*`);
    }
    ...
    public getById(id: number): Observable<any> {
        return this.http.get(`${this.API_URL}/${id}/?include[]=employees_open.*&include[]=employees_close.*&include[]=office.*`);
    }
}

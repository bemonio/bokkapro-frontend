...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => InvoiceFormAutocompleteComponent),
    multi: true,
};

@Component({
    selector: 'app-invoice-form-autocomplete',
    templateUrl: './invoice-form-autocomplete.component.html',
    styleUrls: ['./invoice-form-autocomplete.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class InvoiceFormAutocompleteComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;
    ...
    public loadLazy(event?) {
        ...
        if (event.query) {
            this.filters.push({ key: 'filter{amount.icontains}', value: event.query })
        } else {

...
import { TypeChestService as ModelService } from '../_services/type-chest.service';
import { TypeChestModel as Model } from '../_models/type-chest.model';
...
@Component({
    selector: 'app-types-chests',
    templateUrl: './types-chests.component.html',
    styleUrls: ['./types-chests.component.scss']
})
export class TypesChestsComponent implements OnInit {

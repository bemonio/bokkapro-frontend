...
@Component({
    selector: 'app-deposit-forms',
    templateUrl: './deposit-forms.component.html',
    styleUrls: ['./deposit-forms.component.scss']
})
export class DepositFormsComponent implements OnInit {

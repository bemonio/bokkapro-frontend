...
export class DepositFormService {
    API_URL = `${environment.apiUrl}depositforms`;
    ...
    public getById(id: number): Observable<any> {
        return this.http.get(`${this.API_URL}/${id}/?include[]=packing.*&include[]=bank_account.*&include[]=employee_who_counts.*&include[]=supervisor.*&include[]=supervisor_extra.*`);
    }
}

...
import { TypeProductTransactionService as ModelService } from '../_services/type-product-transaction.service';
...
@Component({
    selector: 'app-types-product-transactions',
    templateUrl: './types-product-transactions.component.html',
    styleUrls: ['./types-product-transactions.component.scss']
})
export class TypesProductTransactionsComponent implements OnInit {

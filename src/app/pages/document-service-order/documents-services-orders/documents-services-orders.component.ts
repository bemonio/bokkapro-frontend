...
import { DocumentServiceOrderService as ModelService } from '../_services/document-service-order.service';
...
@Component({
    selector: 'app-documents-services-orders',
    templateUrl: './documents-services-orders.component.html',
    styleUrls: ['./documents-services-orders.component.scss']
})
export class DocumentsServicesOrdersComponent implements OnInit {
    ...
    public getModels() {
        ...
        this.modelsService.get(this.page, this.per_page, this.sort, this.query, this.filters, this._with).subscribe(
            response => {
                this.requesting = false;
                this.models = response.document_service_orders;
                // this.models = [];
                // response.document_service_orders.forEach(element => {

...
import { ModerationService as ModelService } from '../_services/moderation.service';
...
@Component({
    ...
    styleUrls: ['./moderations.component.scss']
})
    ...
    public getModels() {
        ...
        this.modelsService.get(this.page, this.per_page, this.sort, this.query, this.filters, this._with).subscribe(
            response => {
                this.requesting = false;
                this.models = [];
                response.moderated_objects.forEach(element => {

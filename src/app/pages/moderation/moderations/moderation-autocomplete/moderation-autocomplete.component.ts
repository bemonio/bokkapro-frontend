...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => ModerationAutocompleteComponent),
    multi: true,
};

@Component({
    selector: 'app-moderation-autocomplete',
    templateUrl: './moderation-autocomplete.component.html',
    styleUrls: ['./moderation-autocomplete.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class ModerationAutocompleteComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;

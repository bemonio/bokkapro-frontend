...
import { TypeCompanyService as ModelService } from '../_services/type-company.service';
...
@Component({
    selector: 'app-types-companies',
    templateUrl: './types-companies.component.html',
    styleUrls: ['./types-companies.component.scss']
})
export class TypesCompaniesComponent implements OnInit {

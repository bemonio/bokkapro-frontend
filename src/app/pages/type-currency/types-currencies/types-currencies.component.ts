...
import { TypeCurrencyService as ModelService } from '../_services/type-currency.service';
...
@Component({
    selector: 'app-types-currencies',
    templateUrl: './types-currencies.component.html',
    styleUrls: ['./types-currencies.component.scss']
})
export class TypesCurrenciesComponent implements OnInit {

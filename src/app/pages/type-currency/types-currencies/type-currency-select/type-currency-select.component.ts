...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => TypeCurrencySelectComponent),
    multi: true,
};

@Component({
    selector: 'app-type-currency-select',
    templateUrl: './type-currency-select.component.html',
    styleUrls: ['./type-currency-select.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class TypeCurrencySelectComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;
    ...
    getModels() {
        this.modelsService.get(this.page, this.per_page, this.sort, this.query, this.filters, this._with).toPromise().then(
            response => {
                this.models = response.type_currencies;

...
import { TypeServiceOrderService as ModelService } from '../_services/type-service-order.service';
...
@Component({
    selector: 'app-types-service-orders',
    templateUrl: './types-service-orders.component.html',
    styleUrls: ['./types-service-orders.component.scss']
})
export class TypesServiceOrdersComponent implements OnInit {

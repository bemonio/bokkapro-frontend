...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => ProductAndServiceSelectComponent),
    multi: true,
};

@Component({
    selector: 'app-product-and-service-select',
    templateUrl: './product-and-service-select.component.html',
    styleUrls: ['./product-and-service-select.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class ProductAndServiceSelectComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;
    ...
    public ngOnInit() {
        if (!this.placeholder) {
            this.placeholder = 'ProductAndService';
        }
        this.load();
    }

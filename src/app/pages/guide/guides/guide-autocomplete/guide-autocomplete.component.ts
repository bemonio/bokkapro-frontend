...
export const EPANDED_TEXTAREA_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => GuideAutocompleteComponent),
    multi: true,
};

@Component({
    selector: 'app-guide-autocomplete',
    templateUrl: './guide-autocomplete.component.html',
    styleUrls: ['./guide-autocomplete.component.scss'],
    providers: [EPANDED_TEXTAREA_VALUE_ACCESSOR],
})
export class GuideAutocompleteComponent implements ControlValueAccessor, OnInit {
    @Input() model: any;
    @Input() valid: boolean;

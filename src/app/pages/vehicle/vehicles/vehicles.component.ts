...
import { VehicleService as ModelService } from '../_services/vehicle.service';
...
export class VehiclesComponent implements OnInit {
        ...
        if (this.route.parent.parent.parent.snapshot.url.length > 0) {
            this.route.parent.parent.parent.params.subscribe((params) => {
                if (this.route.parent.parent.parent.parent.parent.snapshot.url.length > 0) {
                    ...
                    this.filters.push({ key: 'filter{office}', value: this.officeId.toString() })
                }
                this.getModels();
            });
        } else {
    ...
    // public showDeleteDialog(vehicle: Model) {
    //     let message;

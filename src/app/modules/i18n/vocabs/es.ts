...
export const locale = {
  ...
  data: {
    ...
    DEPOSITFORM: {
      ...
      ID: 'Id',
      FORMNUMBER: 'Numero de Planilla',
      AMOUNT: 'Monto dice Contener',
    ...
    COMMON: {
      ...
      ADD_NOT_PRECALL: 'AGREGAR NO PRECALL',
      ADD: 'Agregar',
      CLEAR: 'Limpiar',
      VERIFICATED: 'Verificado',
      PRINT: 'Imprimir',
    ...
    REPORT_OPERATION: { 
      ...
      ATM: 'ATM', 
      ATM_TRANSIT_AMOUNT: 'ATM Tránsito',
      ATM_TRANSIT_PACKINGS: 'Envases ATM Tránsito',
    ...
    ORIGIN_DESTINATION: {
      ...
      PRECALL: 'PreCall',
      MONDAY: 'Lunes',
      MONDAY_START_TIME: 'Inicio',
      MONDAY_END_TIME: 'Fin',
      MONDAY_START_TIME_TOUR: 'Inicio Recorrido',
      MONDAY_END_TIME_TOUR: 'Fin Recorrido',
      TUESDAY: 'Martes',
      TUESDAY_START_TIME: 'Inicio',
      TUESDAY_END_TIME: 'Fin',
      TUESDAY_START_TIME_TOUR: 'Inicio Recorrido',
      TUESDAY_END_TIME_TOUR: 'Fin Recorrido',
      WEDNESDAY: 'Miercoles',
      WEDNESDAY_START_TIME: 'Inicio',
      WEDNESDAY_END_TIME: 'Fin',
      WEDNESDAY_START_TIME_TOUR: 'Inicio Recorrido',
      WEDNESDAY_END_TIME_TOUR: 'Fin Recorrido',
      THURSDAY: 'Jueves',
      THURSDAY_START_TIME: 'Inicio',
      THURSDAY_END_TIME: 'Fin',
      THURSDAY_START_TIME_TOUR: 'Inicio Recorrido',
      THURSDAY_END_TIME_TOUR: 'Fin Recorrido',
      FRIDAY: 'Viernes',
      FRIDAY_START_TIME: 'Inicio',
      FRIDAY_END_TIME: 'Fin',
      FRIDAY_START_TIME_TOUR: 'Inicio Recorrido',
      FRIDAY_END_TIME_TOUR: 'Fin Recorrido',
      SATURDAY: 'Sabado',
      SATURDAY_START_TIME: 'Inicio',
      SATURDAY_END_TIME: 'Fin',
      SATURDAY_START_TIME_TOUR: 'Inicio Recorrido',
      SATURDAY_END_TIME_TOUR: 'Fin Recorrido',
      SUNDAY: 'Domingo',
      SUNDAY_START_TIME: 'Inicio',
      SUNDAY_END_TIME: 'Fin',
      SUNDAY_START_TIME_TOUR: 'Inicio Recorrido',
      SUNDAY_END_TIME_TOUR: 'Fin Recorrido',
      DIVISION: 'División'
    },
    CLIENT_BINNACLE: {
    ...
    CHEST: {
      ...
      COST_KEY_CUSTODY: 'Cargo Fijo Custodia de llaves',
      CODE_LOCK: 'Serial Cerradura Electrónica',
    ...
    PRODUCTPART: {
      PRODUCTPART: 'Producto y Servicio Parte',
      PRODUCTPARTS: 'Productos y Servicios Partes',
      PRODUCTANDSERVICE: 'Producto y Servicio',
    ...
    STOCKTRANSACTION: {
      STOCKTRANSACTION: 'Inventario Transacción',
    ...
    STOCKTRANSACTIONDETAIL: {
      ...
      STOCKTRANSACTIONDETAILS: 'Inventario Transacción Detalles',
      ID: 'Id',
      COUNT: 'Cantidad',
      PRODUCTANDSERVICE: 'Producto y Servicio',
      STOCK: 'Inventario',
    ...
    STOCKSERIAL: {
      ...
      STOCKSERIALS: 'Inventario Seriales',
      ID: 'Id',
      CODE: 'Código',
      PRODUCTANDSERVICE: 'Producto y Servicio',
      STOCK: 'Inventario',
    ...
    HEADINVOICE: {
      ...
      HEADINVOICES: 'Encabezados Facturas',
      ID: 'Id',
      INVOICE_NUMBER: 'Número de Factura',
      OFFICE: 'Oficina',
      TAX_RATE: 'Tasa de Impuesto',
      TOTAL_TAX_AMOUNT: 'Total Monto Impuestos',
      TAX_EXEMPT: 'Exento de Impuestos',
      TOTAL_DISCOUNT: 'Total Descuento',
      FROM_DATE: 'Fecha de Inicio Factura',
      TO_DATE: 'Fecha Fin Factura',
      DUE_DATE: 'Fecha Limite de Pago Factura',
      EXCHANGE_RATE: 'Cambio Divisa',
      CURRENCY: 'Divisa',
      // EXCHANGE_RATE: 'Cambio Divisa',
      // PRODUCTANDSERVICE: 'Producto y Servicio',
      ...
      TOTAL_TRAVELS: 'Total Viajes Unidad',
      TOTAL_TRAVELS_DIRECTS: 'Total Viajes Directos',
      TOTAL_APPRAISAL: 'Total Avaluo Unidad',
      TOTAL_HANDLING: 'Total Manipulación Unidad',
      TOTAL_MATERIALS: 'Total Materiales Unidad',
      TOTAL_CUSTODY_CPV: 'Total Custodia Mensual',
      TOTAL_CUSTODY_VAULT: 'Total Custodia de Noche en Sede',
      TOTAL_CUSTODY_PERSONAL_ATM: 'Total Custodia Personal ATM en Banco',
      TOTAL_PIECES: 'Total Piezas Procesadas',    
      TOTAL_FIXED_COSTS_PACKING: 'Total Cargos Fijos Paquetes',
      TOTAL_VIGILANT: 'Total Vigilantes',
      TOTAL_ATM_SUPPLY: 'Total ATM Abastecimiento',
      TOTAL_ATM_FAILURE_1_2_LEVELS: 'Total ATM Fallas 1er y 2do nivel',
      TOTAL_EXCESS: 'Total Excesos',
      TOTAL_EXCESS_TRAVELS: 'Total Viajes',
      TOTAL_EXCESS_TRAVELS_DIRECTS: 'Total Viajes Directos',
      TOTAL_EXCESS_APPRAISAL: 'Total Avalúo',
      TOTAL_EXCESS_HANDLING: 'Total Manipulación',
      TOTAL_EXCESS_MATERIALS: 'Total Materiales',
      TOTAL_EXCESS_VIGILANT_EXTRA_HOURS: 'Total Vigilante Horas Extras',
      TOTAL_EXCESS_CUSTODY_CPV: 'Total Custodia en CPV',

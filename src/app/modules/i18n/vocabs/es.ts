...
export const locale = {
  ...
  data: {
    ...
    SERVICE_ORDER: {
      ...
      EXCESS: 'Excesos',
      EXCESS_TRAVELS: 'Exceso Viajes Unidad',
      EXCESS_TRAVELS_DIRECTS: 'Exceso Viajes Directos',
      EXCESS_APPRAISAL: 'Exceso Avalúo Unidad',
      EXCESS_HANDLING: 'Exceso Manipulación Unidad',
      EXCESS_MATERIALS: 'Exceso Materiales Unidad',
      EXCESS_VIGILANT_EXTRA_HOURS: 'Exceso Vigilante Horas Extras',
      EXCESS_CUSTODY_CPV: 'Exceso Custodia en CPV',
      EXCESS_CUSTODY_VAULT: 'Exceso Custodía en Bóveda',
      EXCESS_CUSTODY_PERSONAL_ATM: 'Exceso Custodia de Personal de ATM en el Banco',
      EXCESS_PIECES: 'Exceso Piezas Procesadas',
    },
    ORIGIN_DESTINATION: {
      ORIGIN_DESTINATION: 'Origen Destino',
